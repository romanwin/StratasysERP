create or replace package body xxobjt_oa2sf_interface_pkg IS
  ...
  -- 1.4  04/03/19     Lingaraj          INC0148774 - insert_into_interface- comment the Code
  --------------------------------------------------------------------
  ...
  */
  ...
  --  1.4   04.03.19     Lingaraj        INC0148774 - remove all call s to  xxobjt_oa2sf_interface_pkg.insert_into_interface
...
*/
 ...
 /* PROCEDURE handle_order_line_event(errbuf       OUT VARCHAR2,
  ...
  --  1.0  03/03/2014  yuval tal        initial build  
  --  1.1  04.03.19     Lingaraj        INC0148774 - remove all call s to  xxobjt_oa2sf_interface_pkg.insert_into_interface
  --                                    handle_order_line_event - Commented , So No Required of this Procedure
  --------------------------------------------------------------------
  ...
  -- 1.3  04.03.19     Lingaraj         INC0148774 - remove all call s to  xxobjt_oa2sf_interface_pkg.insert_into_interface
  --                                    Procedure is not required , Commented 
  --------------------------------------------------------------------
  /*
