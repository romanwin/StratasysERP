CREATE OR REPLACE PACKAGE xxhz_soa_api_pkg AUTHID CURRENT_USER IS
  ...
  -- 1.5       12/05/2020  Roman W.            CHG0047450
  ------------------------------------------------------------------------------------------------------------------/
  C_CHECK_DUPLICATE        CONSTANT VARCHAR2(10) := 'Y';
  C_DUP_CHK_IN_PROCESS_MSG CONSTANT VARCHAR2(3000) := 'Object In process Mode , Please retry Later';

  --------------------------------------------------------------------------------
  -- Ver   When         Who         Description
  -- ----  -----------  ----------  ----------------------------------------------
  -- 1.0   14/12/2020   Roman W.    CHG0047450
  --------------------------------------------------------------------------------
  ...
  -- VERSION  DATE        AUTHOR(S)          DESCRIPTION
  -- -------  ----------- ---------------    ------------------------------------
  -- 1.0    11/05/2016  Somnath Dawn       Initial version
  ...
  function get_site_use_id(p_cust_acct_site_id NUMBER,
                           p_site_use_code     VARCHAR2) return number;
  ...
  --                                          bill_site_use_id
  ------------------------------------------------------------------------------
  procedure get_sites_out_rec(p_sites_out_rec IN OUT xxhz_site_rec);
  --------------------------------------------------------------------------------------
  -- Ver      When        Who                Descr
  -- -------  ----------- ---------------    -------------------------------------------
  --  1.00    24/06/2020  Roman W.           CHG0047450
  --------------------------------------------------------------------------------------
