...
-- --------------------------------------------------------------------------------------------
 ...
 AS
  ...
  BEGIN
    ...
    LOOP
      BEGIN
        ...
        THEN
          xxs3_data_transform_util_pkg.coa_transform(p_field_name => 'EXPENSE_ACCOUNT', p_legacy_company_val => k.expense_acct_segment1, --Legacy Company Value
        ...
        xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_location', p_stage_tab => 'XXS3_RTR_FA_DISTRIBUTIONS', --Staging Table Name
        ...
        xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_book', p_stage_tab => 'XXS3_RTR_FA_DISTRIBUTIONS', --Staging Table Name
                                               p_stage_primary_col => 'XX_FA_DIST_ID', --Staging Table Primary Column Name
                                               p_stage_primary_col_val => k.xx_fa_dist_id, --Staging Table Primary Column Value
  ...
  BEGIN
    ...
    LOOP
      ...
      BEGIN
        ...
        THEN
          xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_category_segment1', p_stage_tab => 'XXS3_RTR_FA_DESCRIPTION', --Staging Table Name
        ...
        THEN
          xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_category_segment2', p_stage_tab => 'XXS3_RTR_FA_DESCRIPTION', --Staging Table Name
                                                 p_stage_primary_col => 'XX_FA_DESC_ID', --Staging Table Primary Column Name
                                                 p_stage_primary_col_val => k.xx_fa_desc_id, --Staging Table Primary Column Value
        ...
        THEN
          xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_key_segment1', p_stage_tab => 'XXS3_RTR_FA_DESCRIPTION', --Staging Table Name
                                                 p_stage_primary_col => 'XX_FA_DESC_ID', --Staging Table Primary Column Name
                                                 p_stage_primary_col_val => k.xx_fa_desc_id, --Staging Table Primary Column Value
        ...
        THEN
          xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_key_segment2', p_stage_tab => 'XXS3_RTR_FA_DESCRIPTION', --Staging Table Name
                                                 p_stage_primary_col => 'XX_FA_DESC_ID', --Staging Table Primary Column Name
                                                 p_stage_primary_col_val => k.xx_fa_desc_id, --Staging Table Primary Column Value
  ...
  BEGIN
    ...
    LOOP
      BEGIN
        ...
        THEN
          xxs3_data_transform_util_pkg.transform(p_mapping_type => 'fa_asset_book', p_stage_tab => 'XXS3_RTR_FA_BOOKS', --Staging Table Name
  ...
  BEGIN
    ...
    fnd_file.put_line(fnd_file.log, 'Truncating S3 staging table for Fixed Asset extract...');
    EXECUTE IMMEDIATE 'TRUNCATE TABLE XX_FA_MASS_ADD_STG@eqt_to_trngs3';
  
  
    fnd_file.put_line(fnd_file.log, 'Inserting into S3 staging table for Fixed Asset extract...');
    l_step := 'Inserting into S3 staging table for Fixed Asset extract...';
  
    INSERT INTO xx_fa_mass_add_stg@eqt_to_trngs3
      (mass_addition_id
      ,asset_number
      ,tag_number
      ,description
