create or replace package xxobjt_oa2sf_interface_pkg IS
  ...
  --  1.5  04.03.19   Lingaraj          INC0148774 - remove all call s to  xxobjt_oa2sf_interface_pkg.insert_into_interface
  --------------------------------------------------------------------
  ...
  --  ver  date        name              desc
  --  1.0  05/09/2010  Dalit A. Raviv    initial build  
  --  1.1  04/03/2019  Lingaraj          INC0148774 - insert_into_interface commented
  --------------------------------------------------------------------
