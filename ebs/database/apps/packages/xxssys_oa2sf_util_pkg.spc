CREATE OR REPLACE PACKAGE xxssys_oa2sf_util_pkg IS
  ...
  --  1.4  25-Mar-2019       Roman Winer          CHG0045353 - New function created to get sf_okc_header_ID
  --  1.5  24-May-2019       Bellona(TCS)         INC0157904 - Increase size of global parameters(g_relatedtosystems
  --                                                   g_relatedtosystems2,g_relatedtosystems3,g_relatedtosystems4,g_relatedtosystems5)
  --                                                   from 255 to 300
  --  1.6 10/06/2019        Roman W              INC0159273-INC0159948 - Failed to debrief due to interface issue / VD
  --  1.7 01/12/2019        Roman W.             CHG0046929 ORACLE-SF Add Oracle Order Creator field

  --------------------------------------------------------------------
  --INC0157904 start - global parameters size increased from 255 to 300
  g_relatedtosystems  VARCHAR2(300) := '';
  g_relatedtosystems2 VARCHAR2(300) := '';
  g_relatedtosystems3 VARCHAR2(300) := '';
  g_relatedtosystems4 VARCHAR2(300) := '';
  g_relatedtosystems5 VARCHAR2(300) := '';
  --INC0157904 end - global parameters size increased from 255 to 300

  g_relatedtoproductfamily VARCHAR2(255) := '';
  ...
  --------------------------------------------------------------------
  FUNCTION get_sf_okc_header_id(p_okc_header_id IN NUMBER) RETURN VARCHAR2;
  ...
  -- 1.1    10/06/2019   Roman W       INC0159273-INC0159948 - Failed to debrief due to interface issue / VD
  ----------------------------------------------------------------------------------------------
