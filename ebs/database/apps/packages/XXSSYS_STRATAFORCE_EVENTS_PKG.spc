...
<<<<<<< .mine
  ...
  --  2.5  18/06/2019  Roman W.                     INC0160471-INC0160411
  --  2.6  07-Nov-2019 Adi Safin                    CHG0046812 - Fix in is_asset_valid2sync
||||||| .r4654
  --  ver  date        name                         desc
  --  1.0  11/14/2017  Diptasurjya Chatterjee(TCS)  CHG0041829 - initial build
  --  2.0  01/04/2018  Roman .W
  ...
  --  2.5  18/06/2019  Roman W.                     INC0160471-INC0160411
  --  2.6  07-Nov-2019 Adi Safin                    CHG0046812 - Fix in is_asset_valid2sync
  --  2.9  15/10/2020  yuval tal                    CHG0048741 - modify push_so_line_fsl_events proc name and logic  to push_order_line_events
=======
  --  ver  date         name                         desc
  --  1.0  11/14/2017   Diptasurjya Chatterjee(TCS)  CHG0041829 - initial build
  --  2.0  01/04/2018   Roman .W
  ...
  --  2.9  08/07/2020   yuval tal                    CHG0048217 - b2b ecomm modify  add handle_contact
>>>>>>> .r4749
  ----------------------------------------------------------------------------
  ...
  g_account_relate_name        VARCHAR2(50) := 'ACCOUNT_RELATIONSHIP';
  ...
  g_account_addr_entity_name   VARCHAR2(50) := 'ACCOUNT_ADDR';
  ...
  --  1.1  04/03/2019  Lingaraj     INC0148774 - Add sync_daily_rate from xxobjt_oa2sf_interface_pkg
  --------------------------------------------------------------------
  ...
  -- Ver    When         Who          Description
  -- -----  ----------   -----------  ---------------------------------------------------------------
  -- 1.0    13/06/2019   Roman W.     INC0160411 - workaround, pushing missing SO_LINE_FSL events
  ---------------------------------------------------------------------------------------------------
  PROCEDURE push_so_line_fsl_events(errbuf  OUT VARCHAR2,
			retcode OUT VARCHAR2);
  ...
  PROCEDURE insert_account_addr_event(p_cust_acct_site_id IN NUMBER,
			  ...
			  p_trigger_name      IN VARCHAR2 /* XXHZ_ACCOUNT_ADDR_SOA_V_TRG */,
			  p_trigger_action    IN VARCHAR2 /* INSERT / UPDATE / DELETE */);
  ...
  ---------------------------------------------------------------------------------
  FUNCTION is_account_addr(p_cust_acct_site_id NUMBER) RETURN VARCHAR2;

  PROCEDURE handle_contact(p_contact_id   IN NUMBER,
		   p_trigger_mode IN VARCHAR2 DEFAULT 'N');
  ...
  ----------------------------------------------------------------------------------------------
  PROCEDURE handle_account_profile(p_cust_account_profile_id IN NUMBER);
