create or replace view xxasn_pb_indirect_all_v as
select
--------------------------------------------------------------------
--  name:            XXASN_PB_INDIRECT_ALL_V
...
--------------------------------------------------------------------
       ...
       demo_unit_price,
       order_by
from   XXASN_PB_INDIRECT_BASIC_V b
union  all
select territory,
       pb_type,
       platform,
       ...
       demo_unit_price,
       order_by
from   XXASN_PB_INDIRECT_SUPPORT_V s
union  all
select territory,
       pb_type,
       platform,
       ...
       demo_unit_price,
       order_by
from   XXASN_PB_INDIRECT_RESINS_V r
union all
select territory,
       pb_type,
       platform,
       ...
       demo_unit_price,
       order_by
from   XXASN_PB_INDIRECT_SYSTEM_V sy;
