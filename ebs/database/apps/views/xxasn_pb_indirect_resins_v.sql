create or replace view xxasn_pb_indirect_resins_v as
select
--------------------------------------------------------------------
--  name:            XXASN_PB_INDIRECT_RESINS_V
...
--  1.1  09/01/2012  Dalit A. Raviv    correct field transfer_price need to send 'RESIN' as parameter to function
--------------------------------------------------------------------
       decode(flv.tag,
              'CN','OBJET CN (OU)',
              'DE','OBJET DE (OU)',
