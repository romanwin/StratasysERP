CREATE OR REPLACE VIEW XXCST_SERIALSUB_ASOFDATE AS
SELECT organization_code, serial_number, segment1, SUBINV,sum(case when transaction_quantity>0 then 1 else -1 end ) QTY,
...
group by organization_code, serial_number, segment1, SUBINV, INVENTORY_ITEM_ID, DESCRIPTION
