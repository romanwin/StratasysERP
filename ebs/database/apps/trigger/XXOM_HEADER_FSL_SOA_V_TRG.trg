CREATE OR REPLACE TRIGGER XXOM_HEADER_FSL_SOA_V_TRG
  INSTEAD OF UPDATE ON XXOM_HEADER_FSL_SOA_V

  FOR EACH ROW
--------------------------------------------------------------------
--  name:     XXOM_HEADER_FSL_SOA_V_TRG
