...
--------------------------------------------------------------------------------------------------
  ...
  --  1.1   03-MAR-2019   Adi Safin                  CHG0044910 - Support extended warranty service contract
  --------------------------------------------------------------------------------------------------
  AFTER INSERT OR UPDATE ON "OKC"."OKC_K_LINES_B"
  FOR EACH ROW
---- CHG0044910 --  1 /*SERVICE*/,14 /*WARRANTY*/, 19 /*EXT_WARRANTY*/) 9 /*COVER_PROD --> SERVICE*/,18 /*COVER_PROD --> Warranty*/,25 /*COVER_PROD --> Extended Warranty*/ )
  when(new.sts_code NOT IN ('ENTERED', 'HOLD') AND new.lse_id IN (1,9,14,18,19,25) AND  
