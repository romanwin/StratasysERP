create or replace trigger xxper_periods_of_service_but
...
begin
--------------------------------------------------------------------
--  name:            XXPER_PERIODS_OF_SERVICE_BUT
...
--                   for each employee that finish to work at Objet.
--------------------------------------------------------------------
--  ver  date        name              desc
...
exception
  when others then
    null;
end XXPER_PERIODS_OF_SERVICE_BUT;
/
