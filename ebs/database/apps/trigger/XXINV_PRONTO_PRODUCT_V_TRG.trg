create or replace trigger APPS."XXINV_PRONTO_PRODUCT_V_TRG"
  INSTEAD OF UPDATE ON XXINV_PRONTO_PRODUCT_V
  FOR EACH ROW
BEGIN
----------------------------------------------------------------------------------------
--  customization code: CHG0036886 PRONTO INTERFACE
--  name:               XXINV_PRONTO_PRODUCT_V_TRG 
--  create by:          ABHJIT 
--  $Revision:          1.0
--  creation date:      
--  Purpose :           
...
ALTER TRIGGER "APPS"."XXINV_PRONTO_PRODUCT_V_TRG" ENABLE;