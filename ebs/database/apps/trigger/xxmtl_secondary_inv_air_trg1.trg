create or replace trigger xxmtl_secondary_inv_air_trg1
  after insert on MTL_SECONDARY_INVENTORIES
  for each row
...
BEGIN
  --------------------------------------------------------------------
  --  name:            XXMTL_SECONDARY_INV_AIR_TRG1
  --  create by:       Dalit A. Raviv
  --  Revision:        1.0
  --  creation date:   06/01/2014
  --------------------------------------------------------------------
  --  purpose :        Trigger that will fire each insert of suninventory
